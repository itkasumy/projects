! function (t, e) {
  "object" == typeof exports && "object" == typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define("EasyPlayer", [], e) : "object" == typeof exports ? exports.EasyPlayer = e() : t.EasyPlayer = e()
}(this, function () {
  return function (t) {
    function e(o) {
    ...
    "21It": function (t, e, i) {
      ...
      t.exports = function (t, e, i) {
        ...
        i.status && s && !s(i.status) ? e(o("Request failed with status code " + i.status, i.config, null, i.request, i)) : t(i)
      }
    },
    "5VQ+": function (t, e, i) {
      "use strict";
      ...
      t.exports = function (t, e) {
        o.forEach(t, function (i, o) {
          o !== e && o.toUpperCase() === e.toUpperCase() && (t[e] = i, delete t[o])
        })
      }
    },
    "7GwW": function (t, e, i) {
      ...
      var o = i("cGG2"),
        ...
        A = i("GHBc"),
        a = i("FtD3"),
        l = "undefined" != typeof window && window.btoa && window.btoa.bind(window) || i("thJu");
      t.exports = function (t) {
        return new Promise(function (e, c) {
          ...
          var h = new XMLHttpRequest,
            ...
            p = !1;
          if ("undefined" == typeof window || !window.XDomainRequest || "withCredentials" in h || A(t.url) || (h = new window.XDomainRequest, f = "onload", p = !0, h.onprogress = function () {}, h.ontimeout = function () {}), t.auth) {
            var v = t.auth.username || "",
              m = t.auth.password || "";
            d.Authorization = "Basic " + l(v + ":" + m)
          }
          if (h.open(t.method.toUpperCase(), n(t.url, t.params, t.paramsSerializer), !0), h.timeout = t.timeout, h[f] = function () {
              ...
              c(a("Network Error", t, null, h)), h = null
            }, h.ontimeout = function () {
              c(a("timeout of " + t.timeout + "ms exceeded", t, "ECONNABORTED", h)), h = null
            }, o.isStandardBrowserEnv()) {
            var g = i("p1b6"),
              b = (t.withCredentials || A(t.url)) && t.xsrfCookieName ? g.read(t.xsrfCookieName) : void 0;
            b && (d[t.xsrfHeaderName] = b)
          }
          if ("setRequestHeader" in h && o.forEach(d, function (t, e) {
    ...
    DQCr: function (t, e, i) {
      ...
      t.exports = function (t, e, i) {
        ...
        var n;
        if (i) n = i(e);
        else if (s.isURLSearchParams(e)) n = e.toString();
        else {
          var r = [];
          s.forEach(e, function (t, e) {
            null !== t && void 0 !== t && (s.isArray(t) && (e += "[]"), s.isArray(t) || (t = [t]), s.forEach(t, function (t) {
              s.isDate(t) ? t = t.toISOString() : s.isObject(t) && (t = JSON.stringify(t)), r.push(o(e) + "=" + o(t))
            }))
          }), n = r.join("&")
        }
    ...
    "FZ+f": function (t, e) {
      function i(t, e) {
        ...
        if (e && "function" == typeof btoa) {
          var n = o(s);
          return [i].concat(s.sources.map(function (t) {
      ...
      (function (e) {
        ...
        var s = i("cGG2"),
          ...
          A = {
            adapter: function () {
              var t;
              return "undefined" != typeof XMLHttpRequest ? t = i("7GwW") : void 0 !== e && (t = i("7GwW")), t
            }(),
            transformRequest: [function (t, e) {
              return n(e, "Content-Type"), s.isFormData(t) || s.isArrayBuffer(t) || s.isBuffer(t) || s.isStream(t) || s.isFile(t) || s.isBlob(t) ? t : s.isArrayBufferView(t) ? t.buffer : s.isURLSearchParams(t) ? (o(e, "application/x-www-form-urlencoded;charset=utf-8"), t.toString()) : s.isObject(t) ? (o(e, "application/json;charset=utf-8"), JSON.stringify(t)) : t
            }],
    ...
    MTIv: function (t, e, i) {
      function o(t, e) {
        for (var i = 0; i < t.length; i++) {
          ...
          if (s) {
            ...
            for (; n < o.parts.length; n++) s.parts.push(c(o.parts[n], e))
          } else {
            for (var r = [], n = 0; n < o.parts.length; n++) r.push(c(o.parts[n], e));
            f[o.id] = {
              id: o.id,
              refs: 1,
              parts: r
      ...
      function s(t, e) {
        for (var i = [], o = {}, s = 0; s < t.length; s++) {
          ...
          o[r] ? o[r].parts.push(c) : i.push(o[r] = {
            id: r,
            parts: [c]
          })
        }
      ...
      function n(t, e) {
        ...
        var o = b[b.length - 1];
        if ("top" === t.insertAt) o ? o.nextSibling ? i.insertBefore(e, o.nextSibling) : i.appendChild(e) : i.insertBefore(e, i.firstChild), b.push(e);
        else if ("bottom" === t.insertAt) i.appendChild(e);
        else {
          if ("object" != typeof t.insertAt || !t.insertAt.before) throw new Error("[Style Loader]\n\n Invalid value for parameter 'insertAt' ('options.insertAt') found.\n Must be 'top', 'bottom', or Object.\n (https://github.com/webpack-contrib/style-loader#insertat)\n");
          var s = v(t.insertInto + " " + t.insertAt.before);
          i.insertBefore(e, s)
        }
      }
      ...
      function A(t) {
        ...
        return t.attrs.type = "text/css", l(e, t.attrs), n(t, e), e
      }

      function a(t) {
        var e = document.createElement("link");
        return t.attrs.type = "text/css", t.attrs.rel = "stylesheet", l(e, t.attrs), n(t, e), e
      }
      ...
      function c(t, e) {
        ...
        if (e.singleton) {
          var l = g++;
          i = m || (m = A(e)), o = u.bind(null, i, l, !1), s = u.bind(null, i, l, !0)
        } else t.sourceMap && "function" == typeof URL && "function" == typeof URL.createObjectURL && "function" == typeof URL.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa ? (i = a(e), o = h.bind(null, i, e), s = function () {
          r(i), i.href && URL.revokeObjectURL(i.href)
        }) : (i = A(e), o = d.bind(null, i), s = function () {
          r(i)
        });
        return o(t),
          function (e) {
      ...
      t.exports = function (t, e) {
        ...
        e = e || {}, e.attrs = "object" == typeof e.attrs ? e.attrs : {}, e.singleton || (e.singleton = p()), e.insertInto || (e.insertInto = "head"), e.insertAt || (e.insertAt = "bottom");
        var i = s(t, e);
        return o(i, e),
          function (t) {
    ...
    NSBD: function (t, e, i) {
      e = t.exports = i("FZ+f")(void 0), e.push([t.i, ".video-wrapper .live .vjs-progress-control,.video-wrapper .live .vjs-remaining-time-display{visibility:hidden}.video-wrapper .alt{position:absolute;left:0;top:0;right:0;bottom:0;background:#000;color:#fff;text-align:center}.video-wrapper .alt>table{width:100%;height:100%}.video-wrapper .alt>table tr>td{vertical-align:middle}.video-wrapper .video-title{position:absolute;top:5px;right:5px;color:#fff;background-color:hsla(0,0%,50%,.5);border-radius:2px;padding:2px 5px;max-width:120px;overflow:hidden;white-space:nowrap;text-overflow:ellipsis}.video-wrapper .video-js .vjs-tech{pointer-events:none}", ""])
    },
    Re3r: function (t, e) {
      function i(t) {
      ...
      t.exports = function (t) {
        return null != t && (i(t) || o(t) || !!t._isBuffer)
      }
    },
    TNV1: function (t, e, i) {
      "use strict";
    ...
    "VU/8": function (t, e) {
      t.exports = function (t, e, i, o, s, n) {
        var r, A = t = t || {},
          a = typeof t.default;
        "object" !== a && "function" !== a || (r = t, A = t.default);
        var l = "function" == typeof A ? A.options : A;
        e && (l.render = e.render, l.staticRenderFns = e.staticRenderFns, l._compiled = !0), i && (l.functional = !0), s && (l._scopeId = s);
        var c;
        if (n ? (c = function (t) {
            t = t || this.$vnode && this.$vnode.ssrContext || this.parent && this.parent.$vnode && this.parent.$vnode.ssrContext, t || "undefined" == typeof __VUE_SSR_CONTEXT__ || (t = __VUE_SSR_CONTEXT__), o && o.call(this, t), t && t._registeredComponents && t._registeredComponents.add(n)
          }, l._ssrRegister = c) : o && (c = o), c) {
          var u = l.functional,
            d = u ? l.render : l.beforeCreate;
          u ? (l._injectStyles = c, l.render = function (t, e) {
    ...
    W2nU: function (t, e) {
      ...
      function r() {
        p && h && (p = !1, h.length ? f = h.concat(f) : v = -1, f.length && A())
      }
      ...
      d.nextTick = function (t) {
        ...
        f.push(new a(t, e)), 1 !== f.length || p || s(A)
    ...
    XmWM: function (t, e, i) {
      ...
      o.prototype.request = function (t) {
        "string" == typeof t && (t = n.merge({
          url: arguments[0]
        }, arguments[1])), t = n.merge(s, this.defaults, {
          method: "get"
    ...
    a4Og: function (t, e, i) {
      ...
      var o = i("/TTR"),
        ...
        r = i("Az4Q");
      i.n(r);
      videojs.options.flash.swf = "easy-player-fluent.swf", videojs.options.techOrder = ["html5", "flash"], videojs.browser.IE_VERSION && (videojs.options.techOrder = ["flash", "html5"]), e.a = {
        name: "easy-player",
        data: function () {
          return {
            player: null,
        ...
        watch: {
          videoUrl: function (t) {
            this.destroyVideoJS(), this.initVideoJS()
          },
          currentTime: function (t) {
            this.player && this.player.currentTime(t)
          }
        },
        mounted: function () {
          this.initVideoJS()
        ...
        computed: {
          videoType: function () {
            var t = "video/mp4";
            return this.rtmp ? t = "rtmp/mp4" : this.m3u8 && (t = "application/x-mpegURL"), t
          },
          videoWrapperStyle: function () {
            var t = this.aspect.split(":"),
              e = parseInt(t[0]) || 16;
            return {
              // paddingBottom: (parseInt(t[1]) || 9) / e * 100 + "%",
              paddingBottom: "0%",
              position: "relative",
              margin: "0 auto",
              overflow: "hidden"
          ...
          http: function () {
            return 0 == (this.src || "").indexOf("http")
          },
          ws: function () {
          ...
          src: function () {
            return this.videoUrl ? 0 === this.videoUrl.indexOf("/") ? location.protocol + "//" + location.host + this.videoUrl : this.videoUrl : ""
          },
          videoHtml: function () {
            return this.src ? this.rtmp || this.http ? '\n                        <video class="video-js vjs-default-skin vjs-big-play-centered" style="width: 100%; height: 100%;" controls preload="none" poster="' + this.snapUrl + '" ' + (this.muted ? "muted" : "") + '>\n                            <source src="' + this.src + '" type="' + this.videoType + '"></source>\n                            <p class="vjs-no-js">\n                                To view this video please enable JavaScript, and consider upgrading to a web browser that\n                                <a href="http://videojs.com/html5-video-support/" target="_blank">\n                                    supports HTML5 video\n                                </a>\n                            </p>\n                        </video>            \n                    ' : '\n                        <canvas style="width: 100%; height: 100%;"></canvas>\n                    ' : '\n                    <div class="alt">\n                        <table>\n                            <tr>\n                                <td>' + this.alt + "</td>\n                            </tr>\n                        </table>\n                    </div>\n                "
          }
        },
        methods: {
          destroyVideoJS: function () {
            this.player && this.player.dispose && (this.player.dispose(), this.player = null), this.player && this.player.destroy && (this.player.destroy(), this.player = null), this.timer && (clearInterval(this.timer), this.timer = 0), this.$emit("update:loading", !1)
          },
          ...
          initVideoJS: function () {
            var t = this;
            if (this.fluent ? videojs.options.flash.swf = "easy-player-fluent.swf" : videojs.options.flash.swf = "easy-player.swf", this.$el.querySelector(".video-inner").innerHTML = this.videoHtml, this.src)
              if (this.rtmp) {
                ...
                this.player = videojs(this.$el.querySelector("video"), {
                  ...
                  document.title = e, t.player.hotkeys({
                    volumeStep: .1,
                    seekStep: 5,
                    enableModifiersForNumbers: !1,
                    enableVolumeScroll: !1
                  })
                }), document.title = e, this.player.on("error", function (e) {
                  var e = t.$el.querySelector(".vjs-error .vjs-error-display .vjs-modal-dialog-content");
                  e.innerHTML = "<a href='http://www.adobe.com/go/getflashplayer' target='_blank'>" + e.textContent + "</a>"
                })
              } else if (this.http) {
              var i = (new Date).getTime();
              this.$emit("update:loading", !0), this.timer = setInterval(function () {
                if ((new Date).getTime() - i > 1e4) return clearInterval(t.timer), t.timer = 0, t.$emit("update:loading", !1), void t.$emit("message", {
                  type: "error",
                  message: "加载播放资源失败"
                });
                n.a.head(t.src).then(function (e) {
                  clearInterval(t.timer), t.timer = 0, t.$emit("update:loading", !1);
                  var i = document.title;
                  t.player = videojs(t.$el.querySelector("video"), {
                    autoplay: t.autoplay
                  }).ready(function () {
                    document.title = i, t.player.hotkeys({
                      volumeStep: .1,
                      seekStep: 5,
                      enableModifiersForNumbers: !1,
                      enableVolumeScroll: !1
                      ...
                      t.$emit("timeupdate", t.player.currentTime())
                    }), t.player.on("pause", function () {
                      t.$emit("pause", t.player.currentTime())
                    }), t.player.on("playing", function () {
                      t.$emit("play", t.player.currentTime())
                    })
                  }), document.title = i, t.player && t.currentTime > 0 && (videojs.browser.IE_VERSION ? t.player.on("loadeddata", function () {
                    setTimeout(function () {
                      t.player.currentTime(t.currentTime)
                    }, 500)
                  }) : t.player.currentTime(t.currentTime))
                }).catch(function (t) {
                  console.log(t.request), console.log(t)
                })
              }, 500)
            } else this.ws && (this.player = new EPlayer.Player(this.src, {
              canvas: this.$el.querySelector(".video-inner canvas"),
              pauseWhenHidden: this.pauseWhenHidden,
              audio: !this.muted,
              videoBufferSize: this.videoBufferSize,
              audioBufferSize: this.audioBufferSize
            }), this.muted || document.body.addEventListener("touchstart", function () {
              t.player.audioOut.unlock(function () {
    ...
    cGG2: function (t, e, i) {
      ...
      function y() {
        function t(t, i) {
          "object" == typeof e[i] && "object" == typeof t ? e[i] = y(e[i], t) : e[i] = t
        }
        for (var e = {}, i = 0, o = arguments.length; i < o; i++) b(arguments[i], t);
        return e
      }

      function B(t, e, i) {
        return b(e, function (e, o) {
          t[o] = i && "function" == typeof e ? w(e, i) : e
        }), t
      }
      var w = i("JP+z"),
        j = i("Re3r"),
    ...
    mJPh: function (t, e) {
      t.exports = function (t) {
        ...
        return t.replace(/url\s*\(((?:[^)(]|\((?:[^)(]+|\([^)(]*\))*\))*)\)/gi, function (t, e) {
          var s = e.trim().replace(/^"(.*)"$/, function (t, e) {
            return e
          }).replace(/^'(.*)'$/, function (t, e) {
            return e
          });
          if (/^(#|data:|http:\/\/|https:\/\/|file:\/\/\/)/i.test(s)) return t;
          var n;
          return n = 0 === s.indexOf("//") ? s : 0 === s.indexOf("/") ? i + s : o + s.replace(/^\.\//, ""), "url(" + JSON.stringify(n) + ")"
        })
      }
    },
    mtWM: function (t, e, i) {
    ...
    oJlt: function (t, e, i) {
      ...
      t.exports = function (t) {
        ...
        return t ? (o.forEach(t.split("\n"), function (t) {
          if (n = t.indexOf(":"), e = o.trim(t.substr(0, n)).toLowerCase(), i = o.trim(t.substr(n + 1)), e) {
            if (r[e] && s.indexOf(e) >= 0) return;
            r[e] = "set-cookie" === e ? (r[e] ? r[e] : []).concat([i]) : r[e] ? r[e] + ", " + i : i
          }
        }), r) : r
      }
    },
    p1b6: function (t, e, i) {
      ...
      t.exports = o.isStandardBrowserEnv() ? function () {
        return {
          write: function (t, e, i, s, n, r) {
            var A = [];
            A.push(t + "=" + encodeURIComponent(e)), o.isNumber(i) && A.push("expires=" + new Date(i).toGMTString()), o.isString(s) && A.push("path=" + s), o.isString(n) && A.push("domain=" + n), !0 === r && A.push("secure"), document.cookie = A.join("; ")
          },
          read: function (t) {
    ...
    rjj0: function (t, e, i) {
      function o(t) {
        for (var e = 0; e < t.length; e++) {
          ...
          if (o) {
            ...
            for (; s < i.parts.length; s++) o.parts.push(n(i.parts[s]));
            o.parts.length > i.parts.length && (o.parts.length = i.parts.length)
          } else {
            for (var r = [], s = 0; s < i.parts.length; s++) r.push(n(i.parts[s]));
            c[i.id] = {
              id: i.id,
              refs: 1,
              parts: r
      ...
      function n(t) {
        ...
        if (v) {
          var n = h++;
          o = d || (d = s()), e = r.bind(null, o, n, !1), i = r.bind(null, o, n, !0)
        } else o = s(), e = A.bind(null, o), i = function () {
          o.parentNode.removeChild(o)
        };
        return e(t),
          function (o) {
    ...
    t8qj: function (t, e, i) {
      ...
      t.exports = function (t, e, i, o, s) {
        return t.config = e, i && (t.code = i), t.request = o, t.response = s, t
      }
    },
    tIFN: function (t, e, i) {
      "use strict";
      ...
      function o(t) {
        var e = new r(t),
          i = n(r.prototype.request, e);
        return s.extend(i, r.prototype, e), s.extend(i, e), i
      }
      var s = i("cGG2"),
        n = i("JP+z"),
        r = i("XmWM"),
        A = i("KCLY"),
        a = o(A);
      a.Axios = r, a.create = function (t) {
        return o(s.merge(A, t))
      }, a.Cancel = i("dVOP"), a.CancelToken = i("cWxy"), a.isCancel = i("pBtG"), a.all = function (t) {
        return Promise.all(t)
      }, a.spread = i("pxG4"), t.exports = a, t.exports.default = a
    },
    tTVk: function (t, e) {
      t.exports = function (t, e) {
    ...
    w3EX: function (t, e) {
      var i = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (t) {
        ...
        o = {
          ...
          CreateVideoElements: function () {
            for (var t = document.querySelectorAll(".eplayer"), e = 0; e < t.length; e++) new o.VideoElement(t[e])
          },
          Fill: function (t, e) {
            if (t.fill) t.fill(e);
            else
      ...
      "complete" === document.readyState ? o.CreateVideoElements() : document.addEventListener("DOMContentLoaded", o.CreateVideoElements), o.VideoElement = function () {
        "use strict";
        var t = function t(e) {
          var i = e.dataset.url;
          ...
          for (var r in e.dataset) try {
            n[r] = JSON.parse(e.dataset[r])
          } catch (t) {
            n[r] = e.dataset[r]
          }
          if (this.player = new o.Player(i, n), e.playerInstance = this.player, !n.poster || n.autoplay || this.player.options.streaming || (n.decodeFirstFrame = !1, this.poster = new Image, this.poster.src = n.poster, this.poster.addEventListener("load", this.posterLoaded), s(this.poster, {
              display: "block",
              zIndex: 1,
              position: "absolute",
              top: 0,
              ...
              bottom: 0,
              right: 0
            }), this.container.appendChild(this.poster)), this.player.options.streaming || this.container.addEventListener("click", this.onClick.bind(this)), (n.autoplay || this.player.options.streaming) && (this.playButton.style.display = "none"), this.player.audioOut && !this.player.audioOut.unlocked) {
            var A = this.container;
            (n.autoplay || this.player.options.streaming) && (this.unmuteButton = document.createElement("div"), this.unmuteButton.innerHTML = t.UNMUTE_BUTTON, s(this.unmuteButton, {
              zIndex: 2,
              position: "absolute",
              bottom: "10px",
              right: "20px",
              ...
              opacity: "0.7",
              cursor: "pointer"
            }), this.container.appendChild(this.unmuteButton), A = this.unmuteButton), this.unlockAudioBound = this.onUnlockAudio.bind(this, A), A.addEventListener("touchstart", this.unlockAudioBound, !1), A.addEventListener("click", this.unlockAudioBound, !0)
          }
        };
        ...
        return t.prototype.showHide = function (t) {
          ...
          this.video && this.video.seek(t + e), this.audio && this.audio.seek(t + e), this.startTime = o.Now() - t
          ...
          this.isPlaying || (this.isPlaying = !0, this.startTime = o.Now() - this.currentTime), this.options.streaming ? this.updateForStreaming() : this.updateForStaticFile()
          ...
          if (this.audio && this.audio.canPlay) {
            ...
            var i = o.Now() - this.startTime + this.video.startTime,
              s = i - this.video.currentTime,
              n = 1 / this.video.frameRate;
            this.video && s > 0 && (s > 2 * n && (this.startTime += s), t = !this.video.decode()), e = this.demuxer.currentTime - i
          }
          this.source.resume(e), t && this.source.completed && (this.loop ? this.seek(0) : this.pause())
        }, t
      }(), o.BitBuffer = function () {
        "use strict";
        var t = function t(e, o) {
          "object" == (void 0 === e ? "undefined" : i(e)) ? (this.bytes = e instanceof Uint8Array ? e : new Uint8Array(e), this.byteLength = this.bytes.length) : (this.bytes = new Uint8Array(e || 1048576), this.byteLength = 0), this.mode = o || t.MODE.EXPAND, this.index = 0
        };
        return t.prototype.resize = function (t) {
          ...
          if (o)
            for (var s = 0, r = 0; r < e.length; r++) s += e[r].byteLength;
          else s = e.byteLength;
          if (s > n)
            if (this.mode === t.MODE.EXPAND) {
              var A = Math.max(2 * this.bytes.length, s - n);
              this.resize(A)
            } else this.evict(s);
          if (o)
            for (var r = 0; r < e.length; r++) this.appendSingleBuffer(e[r]);
          ...
          for (var e = this.index, i = 0; t;) {
            var o = this.bytes[e >> 3],
              s = 8 - (7 & e),
              n = s < t ? s : t,
              r = s - n;
            i = i << n | (o & 255 >> 8 - n << r) >> r, e += n, t -= n
          }
          return i
      ...
      }(), o.Source.AjaxProgressive = function () {
        "use strict";
        var t = function (t, e) {
        ...
        return t.prototype.connect = function (t) {
          ...
          !this.isLoading && this.throttled && 8 * this.loadTime + 2 > t && this.loadNextChunk()
        }, t.prototype.destroy = function () {
          ...
          this.isLoading = !0, this.loadStartTime = o.Now(), this.request = new XMLHttpRequest, this.request.onreadystatechange = function () {
          ...
          this.established = !0, this.progress = 1, this.loadedSize += t.byteLength, this.loadFails = 0, this.isLoading = !1, this.destination && this.destination.write(t), this.loadTime = o.Now() - this.loadStartTime, this.throttled || this.loadNextChunk()
        }, t
      }(), o.Source.WebSocket = function () {
        "use strict";
        var t = function (t, e) {
        ...
        return t.prototype.connect = function (t, e) {
          ...
          if (this.leftoverBytes) {
            ...
            this.bits = new o.BitBuffer(e), this.bits.write([this.leftoverBytes, t])
          } else this.bits = new o.BitBuffer(t);
          ...
          var t = 187 + (this.bits.index >> 3),
            ...
            o = (this.bits.read(2), this.bits.read(2)),
            s = (this.bits.read(4), this.pidsToStreamIds[i]);
          if (e && s) {
            var n = this.pesPacketInfo[s];
            n && n.currentLength && this.packetComplete(n)
          }
          if (1 & o) {
            if (2 & o) {
              var r = this.bits.read(8);
              this.bits.skip(r << 3)
            }
            if (e && this.bits.nextBytesAreStartCode()) {
              ...
              if (n) {
                ...
                if (2 & a) {
                  ...
                  this.bits.skip(1), u = (1073741824 * d + 32768 * h + f) / 9e4, this.currentTime = u, -1 === this.startTime && (this.startTime = u)
                }
                var p = A ? A - l - 3 : 0;
                this.packetStart(n, u, p)
              }
              this.bits.index = c
            }
            if (s) {
              ...
              if (n) {
                var v = this.bits.index >> 3,
                  m = this.packetAddData(n, v, t),
                  g = !e && 2 & o;
                (m || this.guessVideoFrameEnd && g) && this.packetComplete(n)
              }
            }
          }
          ...
          for (var t = this.bits.index >> 3, e = 0; e < 187; e++)
            if (71 === this.bits.bytes[t + e]) {
              for (var i = !0, o = 1; o < 5; o++)
                if (71 !== this.bits.bytes[t + e + 188 * o]) {
                  i = !1;
                  break
                }
      ...
      }(), o.Decoder.MPEG1Video = function () {
        "use strict";
        var t = function (t) {
          o.Decoder.Base.call(this, t);
          var e = t.videoBufferSize || 524288,
            i = t.streaming ? o.BitBuffer.MODE.EVICT : o.BitBuffer.MODE.EXPAND;
          this.bits = new o.BitBuffer(e, i), this.customIntraQuantMatrix = new Uint8Array(64), this.customNonIntraQuantMatrix = new Uint8Array(64), this.blockData = new Int32Array(64), this.currentFrame = 0, this.decodeFirstFrame = !1 !== t.decodeFirstFrame
        };
        return t.prototype = Object.create(o.Decoder.Base.prototype), t.prototype.constructor = t, t.prototype.write = function (e, i) {
          if (o.Decoder.Base.prototype.write.call(this, e, i), !this.hasSequenceHeader) {
            if (-1 === this.bits.findStartCode(t.START.SEQUENCE)) return !1;
            this.decodeSequenceHeader(), this.decodeFirstFrame && this.decode()
          }
        }, t.prototype.decode = function () {
          return !!this.hasSequenceHeader && (-1 === this.bits.findStartCode(t.START.PICTURE) ? (this.bits.byteLength, this.bits.index, !1) : (this.decodePicture(), this.advanceDecodedTime(1 / this.frameRate), !0))
          ...
          if (this.bits.skip(4), this.frameRate = t.PICTURE_RATE[this.bits.read(4)], this.bits.skip(30), e === this.width && i === this.height || (this.width = e, this.height = i, this.initBuffers(), this.destination && this.destination.resize(e, i)), this.bits.read(1)) {
            for (var o = 0; o < 64; o++) this.customIntraQuantMatrix[t.ZIG_ZAG[o]] = this.bits.read(8);
          ...
          if (this.currentFrame++, this.bits.skip(10), this.pictureType = this.bits.read(3), this.bits.skip(16), !(this.pictureType <= 0 || this.pictureType >= t.PICTURE_TYPE.B)) {
            ...
            if (-1 !== i && this.bits.rewind(32), this.destination && this.destination.render(this.currentY, this.currentCr, this.currentCb), this.pictureType === t.PICTURE_TYPE.INTRA || this.pictureType === t.PICTURE_TYPE.PREDICTIVE) {
              var o = this.forwardY,
                ...
                A = this.forwardCb,
                a = this.forwardCb32;
              this.forwardY = this.currentY, this.forwardY32 = this.currentY32, this.forwardCr = this.currentCr, this.forwardCr32 = this.currentCr32, this.forwardCb = this.currentCb, this.forwardCb32 = this.currentCb32, this.currentY = o, this.currentY32 = s, this.currentCr = n, this.currentCr32 = r, this.currentCb = A, this.currentCb32 = a
            }
          }
          ...
          var o = t.MACROBLOCK_TYPE[this.pictureType];
          ...
          for (var s = 0 != (2 & this.macroblockType) ? this.readHuffman(t.CODE_BLOCK_PATTERN) : this.macroblockIntra ? 63 : 0, n = 0, r = 32; n < 6; n++) 0 != (s & r) && this.decodeBlock(n), r >>= 1
        ...
        }, t.prototype.copyMacroblock = function (t, e, i, o, s) {
          var n, r, A, a, l, c, u, d, h, f = this.currentY32,
            p = this.currentCb32,
            v = this.currentCr32;
          n = this.codedWidth, r = n - 16, A = t >> 1, a = e >> 1, l = 1 == (1 & t), c = 1 == (1 & e), u = ((this.mbRow << 4) + a) * n + (this.mbCol << 4) + A, d = this.mbRow * n + this.mbCol << 2, h = d + (n << 2);
          var m, g, b, y;
          if (l)
            if (c)
              for (; d < h;) {
                for (g = i[u] + i[u + n], u++, m = 0; m < 4; m++) b = i[u] + i[u + n], u++, y = g + b + 2 >> 2 & 255, g = i[u] + i[u + n], u++, y |= g + b + 2 << 6 & 65280, b = i[u] + i[u + n], u++, y |= g + b + 2 << 14 & 16711680, g = i[u] + i[u + n], u++, y |= g + b + 2 << 22 & 4278190080, f[d++] = y;
                d += r >> 2, u += r - 1
              } else
                for (; d < h;) {
                  for (g = i[u++], m = 0; m < 4; m++) b = i[u++], y = g + b + 1 >> 1 & 255, g = i[u++], y |= g + b + 1 << 7 & 65280, b = i[u++], y |= g + b + 1 << 15 & 16711680, g = i[u++], y |= g + b + 1 << 23 & 4278190080, f[d++] = y;
                  d += r >> 2, u += r - 1
                } else if (c)
                  for (; d < h;) {
                    for (m = 0; m < 4; m++) y = i[u] + i[u + n] + 1 >> 1 & 255, u++, y |= i[u] + i[u + n] + 1 << 7 & 65280, u++, y |= i[u] + i[u + n] + 1 << 15 & 16711680, u++, y |= i[u] + i[u + n] + 1 << 23 & 4278190080, u++, f[d++] = y;
                    d += r >> 2, u += r
                  } else
                    for (; d < h;) {
                      for (m = 0; m < 4; m++) y = i[u], u++, y |= i[u] << 8, u++, y |= i[u] << 16, u++, y |= i[u] << 24, u++, f[d++] = y;
                      d += r >> 2, u += r
                    }
          n = this.halfWidth, r = n - 8, A = t / 2 >> 1, a = e / 2 >> 1, l = 1 == (t / 2 & 1), c = 1 == (e / 2 & 1), u = ((this.mbRow << 3) + a) * n + (this.mbCol << 3) + A, d = this.mbRow * n + this.mbCol << 1, h = d + (n << 1);
          var B, w, j, E, x, T;
          if (l)
            if (c)
              for (; d < h;) {
                for (B = o[u] + o[u + n], E = s[u] + s[u + n], u++, m = 0; m < 2; m++) w = o[u] + o[u + n], x = s[u] + s[u + n], u++, j = B + w + 2 >> 2 & 255, T = E + x + 2 >> 2 & 255, B = o[u] + o[u + n], E = s[u] + s[u + n], u++, j |= B + w + 2 << 6 & 65280, T |= E + x + 2 << 6 & 65280, w = o[u] + o[u + n], x = s[u] + s[u + n], u++, j |= B + w + 2 << 14 & 16711680, T |= E + x + 2 << 14 & 16711680, B = o[u] + o[u + n], E = s[u] + s[u + n], u++, j |= B + w + 2 << 22 & 4278190080, T |= E + x + 2 << 22 & 4278190080, v[d] = j, p[d] = T, d++;
                d += r >> 2, u += r - 1
              } else
                for (; d < h;) {
                  for (B = o[u], E = s[u], u++, m = 0; m < 2; m++) w = o[u], x = s[u++], j = B + w + 1 >> 1 & 255, T = E + x + 1 >> 1 & 255, B = o[u], E = s[u++], j |= B + w + 1 << 7 & 65280, T |= E + x + 1 << 7 & 65280, w = o[u], x = s[u++], j |= B + w + 1 << 15 & 16711680, T |= E + x + 1 << 15 & 16711680, B = o[u], E = s[u++], j |= B + w + 1 << 23 & 4278190080, T |= E + x + 1 << 23 & 4278190080, v[d] = j, p[d] = T, d++;
                  d += r >> 2, u += r - 1
                } else if (c)
                  for (; d < h;) {
                    for (m = 0; m < 2; m++) j = o[u] + o[u + n] + 1 >> 1 & 255, T = s[u] + s[u + n] + 1 >> 1 & 255, u++, j |= o[u] + o[u + n] + 1 << 7 & 65280, T |= s[u] + s[u + n] + 1 << 7 & 65280, u++, j |= o[u] + o[u + n] + 1 << 15 & 16711680, T |= s[u] + s[u + n] + 1 << 15 & 16711680, u++, j |= o[u] + o[u + n] + 1 << 23 & 4278190080, T |= s[u] + s[u + n] + 1 << 23 & 4278190080, u++, v[d] = j, p[d] = T, d++;
                    d += r >> 2, u += r
                  } else
                    for (; d < h;) {
                      for (m = 0; m < 2; m++) j = o[u], T = s[u], u++, j |= o[u] << 8, T |= s[u] << 8, u++, j |= o[u] << 16, T |= s[u] << 16, u++, j |= o[u] << 24, T |= s[u] << 24, u++, v[d] = j, p[d] = T, d++;
                      d += r >> 2, u += r
                    }
          ...
          if (this.macroblockIntra) {
            var n, r;
            if (e < 4 ? (n = this.dcPredictorY, r = this.readHuffman(t.DCT_DC_SIZE_LUMINANCE)) : (n = 4 === e ? this.dcPredictorCr : this.dcPredictorCb, r = this.readHuffman(t.DCT_DC_SIZE_CHROMINANCE)), r > 0) {
              var A = this.bits.read(r);
              this.blockData[0] = 0 != (A & 1 << r - 1) ? n + A : n + (-1 << r | A + 1)
            } else this.blockData[0] = n;
          ...
          for (var a = 0;;) {
            ...
            65535 === c ? (l = this.bits.read(6), a = this.bits.read(8), 0 === a ? a = this.bits.read(8) : 128 === a ? a = this.bits.read(8) - 256 : a > 128 && (a -= 256)) : (l = c >> 8, a = 255 & c, this.bits.read(1) && (a = -a)), s += l;
            var u = t.ZIG_ZAG[s];
            s++, a <<= 1, this.macroblockIntra || (a += a < 0 ? -1 : 1), a = a * this.quantizerScale * i[u] >> 4, 0 == (1 & a) && (a -= a > 0 ? 1 : -1), a > 2047 ? a = 2047 : a < -2048 && (a = -2048), this.blockData[u] = a * t.PREMULTIPLIER_MATRIX[u]
          }
          var d, h, f;
          e < 4 ? (d = this.currentY, f = this.codedWidth - 8, h = this.mbRow * this.codedWidth + this.mbCol << 4, 0 != (1 & e) && (h += 8), 0 != (2 & e) && (h += this.codedWidth << 3)) : (d = 4 === e ? this.currentCb : this.currentCr, f = (this.codedWidth >> 1) - 8, h = (this.mbRow * this.codedWidth << 2) + (this.mbCol << 3)), this.macroblockIntra ? 1 === s ? (t.CopyValueToDestination(this.blockData[0] + 128 >> 8, d, h, f), this.blockData[0] = 0) : (t.IDCT(this.blockData), t.CopyBlockToDestination(this.blockData, d, h, f), o.Fill(this.blockData, 0)) : 1 === s ? (t.AddValueToDestination(this.blockData[0] + 128 >> 8, d, h, f), this.blockData[0] = 0) : (t.IDCT(this.blockData), t.AddBlockToDestination(this.blockData, d, h, f), o.Fill(this.blockData, 0)), s = 0
        }, t.CopyBlockToDestination = function (t, e, i, o) {
          for (var s = 0; s < 64; s += 8, i += o + 8) e[i + 0] = t[s + 0], e[i + 1] = t[s + 1], e[i + 2] = t[s + 2], e[i + 3] = t[s + 3], e[i + 4] = t[s + 4], e[i + 5] = t[s + 5], e[i + 6] = t[s + 6], e[i + 7] = t[s + 7]
        }, t.AddBlockToDestination = function (t, e, i, o) {
          for (var s = 0; s < 64; s += 8, i += o + 8) e[i + 0] += t[s + 0], e[i + 1] += t[s + 1], e[i + 2] += t[s + 2], e[i + 3] += t[s + 3], e[i + 4] += t[s + 4], e[i + 5] += t[s + 5], e[i + 6] += t[s + 6], e[i + 7] += t[s + 7]
        }, t.CopyValueToDestination = function (t, e, i, o) {
          for (var s = 0; s < 64; s += 8, i += o + 8) e[i + 0] = t, e[i + 1] = t, e[i + 2] = t, e[i + 3] = t, e[i + 4] = t, e[i + 5] = t, e[i + 6] = t, e[i + 7] = t
        }, t.AddValueToDestination = function (t, e, i, o) {
          for (var s = 0; s < 64; s += 8, i += o + 8) e[i + 0] += t, e[i + 1] += t, e[i + 2] += t, e[i + 3] += t, e[i + 4] += t, e[i + 5] += t, e[i + 6] += t, e[i + 7] += t
        }, t.IDCT = function (t) {
          for (var e, i, o, s, n, r, A, a, l, c, u, d, h, f, p, v, m, g, b = 0; b < 8; ++b) e = t[32 + b], i = t[16 + b] + t[48 + b], o = t[40 + b] - t[24 + b], r = t[8 + b] + t[56 + b], A = t[24 + b] + t[40 + b], s = t[8 + b] - t[56 + b], n = r + A, a = t[0 + b], h = (473 * s - 196 * o + 128 >> 8) - n, l = h - (362 * (r - A) + 128 >> 8), c = a - e, u = (362 * (t[16 + b] - t[48 + b]) + 128 >> 8) - i, d = a + e, f = c + u, p = d + i, v = c - u, m = d - i, g = -l - (473 * o + 196 * s + 128 >> 8), t[0 + b] = n + p, t[8 + b] = h + f, t[16 + b] = v - l, t[24 + b] = m - g, t[32 + b] = m + g, t[40 + b] = l + v, t[48 + b] = f - h, t[56 + b] = p - n;
          for (var b = 0; b < 64; b += 8) e = t[4 + b], i = t[2 + b] + t[6 + b], o = t[5 + b] - t[3 + b], r = t[1 + b] + t[7 + b], A = t[3 + b] + t[5 + b], s = t[1 + b] - t[7 + b], n = r + A, a = t[0 + b], h = (473 * s - 196 * o + 128 >> 8) - n, l = h - (362 * (r - A) + 128 >> 8), c = a - e, u = (362 * (t[2 + b] - t[6 + b]) + 128 >> 8) - i, d = a + e, f = c + u, p = d + i, v = c - u, m = d - i, g = -l - (473 * o + 196 * s + 128 >> 8), t[0 + b] = n + p + 128 >> 8, t[1 + b] = h + f + 128 >> 8, t[2 + b] = v - l + 128 >> 8, t[3 + b] = m - g + 128 >> 8, t[4 + b] = m + g + 128 >> 8, t[5 + b] = l + v + 128 >> 8, t[6 + b] = f - h + 128 >> 8, t[7 + b] = p - n + 128 >> 8
      ...
      }(), o.Decoder.MP2Audio = function () {
        "use strict";
        var t = function t(e) {
          o.Decoder.Base.call(this, e);
          var i = e.audioBufferSize || 131072,
            s = e.streaming ? o.BitBuffer.MODE.EVICT : o.BitBuffer.MODE.EXPAND;
          this.bits = new o.BitBuffer(i, s), this.left = new Float32Array(1152), this.right = new Float32Array(1152), this.sampleRate = 44100, this.D = new Float32Array(1024), this.D.set(t.SYNTHESIS_WINDOW, 0), this.D.set(t.SYNTHESIS_WINDOW, 512), this.V = new Float32Array(1024), this.U = new Int32Array(32), this.VPos = 0, this.allocation = [new Array(32), new Array(32)], this.scaleFactorInfo = [new Uint8Array(32), new Uint8Array(32)], this.scaleFactor = [new Array(32), new Array(32)], this.sample = [new Array(32), new Array(32)];
          for (var n = 0; n < 2; n++)
            for (var r = 0; r < 32; r++) this.scaleFactor[n][r] = [0, 0, 0], this.sample[n][r] = [0, 0, 0]
        };
        return t.prototype = Object.create(o.Decoder.Base.prototype), t.prototype.constructor = t, t.prototype.decode = function () {
          ...
          var s = this.bits.read(11),
            ...
            r = this.bits.read(2),
            A = !this.bits.read(1);
          if (s !== t.FRAME_SYNC || n !== t.VERSION.MPEG_1 || r !== t.LAYER.II) return 0;
          var a = this.bits.read(4) - 1;
          if (a > 13) return 0;
          var l = this.bits.read(2),
            c = t.SAMPLE_RATE[l];
          if (3 === l) return 0;
          n === t.VERSION.MPEG_2 && (l += 4, a += 14);
          var u = this.bits.read(1),
            d = (this.bits.read(1), this.bits.read(2)),
            h = 0;
          d === t.MODE.JOINT_STEREO ? h = this.bits.read(2) + 1 << 2 : (this.bits.skip(2), h = d === t.MODE.MONO ? 0 : 32), this.bits.skip(4), A && this.bits.skip(16);
          var f = t.BIT_RATE[a],
            c = t.SAMPLE_RATE[l],
            p = 144e3 * f / c + u | 0,
            v = 0,
            m = 0;
          if (n === t.VERSION.MPEG_2) v = 2, m = 30;
          else {
            var g = d === t.MODE.MONO ? 0 : 1,
              b = t.QUANT_LUT_STEP_1[g][a];
            v = t.QUANT_LUT_STEP_2[b][l], m = 63 & v, v >>= 6
          }
          h > m && (h = m);
          for (var y = 0; y < h; y++) this.allocation[0][y] = this.readAllocation(y, v), this.allocation[1][y] = this.readAllocation(y, v);
          for (var y = h; y < m; y++) this.allocation[0][y] = this.allocation[1][y] = this.readAllocation(y, v);
          for (var B = d === t.MODE.MONO ? 1 : 2, y = 0; y < m; y++) {
            for (w = 0; w < B; w++) this.allocation[w][y] && (this.scaleFactorInfo[w][y] = this.bits.read(2));
            d === t.MODE.MONO && (this.scaleFactorInfo[1][y] = this.scaleFactorInfo[0][y])
          }
          for (var y = 0; y < m; y++) {
            for (var w = 0; w < B; w++)
              if (this.allocation[w][y]) {
                var j = this.scaleFactor[w][y];
                switch (this.scaleFactorInfo[w][y]) {
                  case 0:
                    j[0] = this.bits.read(6), j[1] = this.bits.read(6), j[2] = this.bits.read(6);
                    break;
                  case 1:
                    j[0] = j[1] = this.bits.read(6), j[2] = this.bits.read(6);
                    break;
                  case 2:
                    j[0] = j[1] = j[2] = this.bits.read(6);
                    break;
                  case 3:
                    j[0] = this.bits.read(6), j[1] = j[2] = this.bits.read(6)
                }
              }
            d === t.MODE.MONO && (this.scaleFactor[1][y][0] = this.scaleFactor[0][y][0], this.scaleFactor[1][y][1] = this.scaleFactor[0][y][1], this.scaleFactor[1][y][2] = this.scaleFactor[0][y][2])
          }
          for (var E = 0, x = 0; x < 3; x++)
            for (var T = 0; T < 4; T++) {
              for (var y = 0; y < h; y++) this.readSamples(0, y, x), this.readSamples(1, y, x);
              for (var y = h; y < m; y++) this.readSamples(0, y, x), this.sample[1][y][0] = this.sample[0][y][0], this.sample[1][y][1] = this.sample[0][y][1], this.sample[1][y][2] = this.sample[0][y][2];
              for (var y = m; y < 32; y++) this.sample[0][y][0] = 0, this.sample[0][y][1] = 0, this.sample[0][y][2] = 0, this.sample[1][y][0] = 0, this.sample[1][y][1] = 0, this.sample[1][y][2] = 0;
              for (var C = 0; C < 3; C++) {
                this.VPos = this.VPos - 64 & 1023;
                for (var w = 0; w < 2; w++) {
                  t.MatrixTransform(this.sample[w], C, this.V, this.VPos), o.Fill(this.U, 0);
                  for (var I = 512 - (this.VPos >> 1), S = this.VPos % 128 >> 1; S < 1024;) {
                    for (var R = 0; R < 32; ++R) this.U[R] += this.D[I++] * this.V[S++];
                    S += 96, I += 32
                  }
                  for (S = 1120 - S, I -= 480; S < 1024;) {
                    for (var R = 0; R < 32; ++R) this.U[R] += this.D[I++] * this.V[S++];
                    S += 96, I += 32
                  }
                  for (var k = 0 === w ? e : i, F = 0; F < 32; F++) k[E + F] = this.U[F] / 2147418112
                }
                E += 32
              }
            }
          ...
          var o = t.QUANT_LUT_STEP_3[i][e],
            s = t.QUANT_LUT_STEP4[15 & o][this.bits.read(o >> 4)];
          return s ? t.QUANT_TAB[s - 1] : 0
        }, t.prototype.readSamples = function (e, i, o) {
          var s = this.allocation[e][i],
            n = this.scaleFactor[e][i][o],
            r = this.sample[e][i],
            A = 0;
          if (!s) return void(r[0] = r[1] = r[2] = 0);
          if (63 === n) n = 0;
          else {
            var a = n / 3 | 0;
            n = t.SCALEFACTOR_BASE[n % 3] + (1 << a >> 1) >> a
          }
          var l = s.levels;
          s.group ? (A = this.bits.read(s.bits), r[0] = A % l, A = A / l | 0, r[1] = A % l, r[2] = A / l | 0) : (r[0] = this.bits.read(s.bits), r[1] = this.bits.read(s.bits), r[2] = this.bits.read(s.bits));
          var c = 65536 / (l + 1) | 0;
          l = (l + 1 >> 1) - 1, A = (l - r[0]) * c, r[0] = A * (n >> 12) + (A * (4095 & n) + 2048 >> 12) >> 12, A = (l - r[1]) * c, r[1] = A * (n >> 12) + (A * (4095 & n) + 2048 >> 12) >> 12, A = (l - r[2]) * c, r[2] = A * (n >> 12) + (A * (4095 & n) + 2048 >> 12) >> 12
        }, t.MatrixTransform = function (t, e, i, o) {
          var s, n, r, A, a, l, c, u, d, h, f, p, v, m, g, b, y, B, w, j, E, x, T, C, I, S, R, k, F, D, U, Q, M;
          s = t[0][e] + t[31][e], n = .500602998235 * (t[0][e] - t[31][e]), r = t[1][e] + t[30][e], A = .505470959898 * (t[1][e] - t[30][e]), a = t[2][e] + t[29][e], l = .515447309923 * (t[2][e] - t[29][e]), c = t[3][e] + t[28][e], u = .53104259109 * (t[3][e] - t[28][e]), d = t[4][e] + t[27][e], h = .553103896034 * (t[4][e] - t[27][e]), f = t[5][e] + t[26][e], p = .582934968206 * (t[5][e] - t[26][e]), v = t[6][e] + t[25][e], m = .622504123036 * (t[6][e] - t[25][e]), g = t[7][e] + t[24][e], b = .674808341455 * (t[7][e] - t[24][e]), y = t[8][e] + t[23][e], B = .744536271002 * (t[8][e] - t[23][e]), w = t[9][e] + t[22][e], j = .839349645416 * (t[9][e] - t[22][e]), E = t[10][e] + t[21][e], x = .972568237862 * (t[10][e] - t[21][e]), T = t[11][e] + t[20][e], C = 1.16943993343 * (t[11][e] - t[20][e]), I = t[12][e] + t[19][e], S = 1.48416461631 * (t[12][e] - t[19][e]), R = t[13][e] + t[18][e], k = 2.05778100995 * (t[13][e] - t[18][e]), F = t[14][e] + t[17][e], D = 3.40760841847 * (t[14][e] - t[17][e]), U = t[15][e] + t[16][e], Q = 10.1900081235 * (t[15][e] - t[16][e]), M = s + U, U = .502419286188 * (s - U), s = r + F, F = .52249861494 * (r - F), r = a + R, R = .566944034816 * (a - R), a = c + I, I = .64682178336 * (c - I), c = d + T, T = .788154623451 * (d - T), d = f + E, E = 1.06067768599 * (f - E), f = v + w, w = 1.72244709824 * (v - w), v = g + y, y = 5.10114861869 * (g - y), g = M + v, v = .509795579104 * (M - v), M = s + f, s = .601344886935 * (s - f), f = r + d, d = .899976223136 * (r - d), r = a + c, c = 2.56291544774 * (a - c), a = g + r, g = .541196100146 * (g - r), r = M + f, f = 1.30656296488 * (M - f), M = a + r, a = .707106781187 * (a - r), r = g + f, g = .707106781187 * (g - f), r += g, f = v + c, v = .541196100146 * (v - c), c = s + d, d = 1.30656296488 * (s - d), s = f + c, c = .707106781187 * (f - c), f = v + d, v = .707106781187 * (v - d), f += v, s += f, f += c, c += v, d = U + y, U = .509795579104 * (U - y), y = F + w, F = .601344886935 * (F - w), w = R + E, E = .899976223136 * (R - E), R = I + T, T = 2.56291544774 * (I - T), I = d + R, d = .541196100146 * (d - R), R = y + w, w = 1.30656296488 * (y - w), y = I + R, R = .707106781187 * (I - R), I = d + w, w = .707106781187 * (d - w), I += w, d = U + T, U = .541196100146 * (U - T), T = F + E, E = 1.30656296488 * (F - E), F = d + T, T = .707106781187 * (d - T), d = U + E, U = .707106781187 * (U - E), d += U, F += d, d += T, T += U, y += F, F += I, I += d, d += R, R += T, T += w, w += U, E = n + Q, n = .502419286188 * (n - Q), Q = A + D, A = .52249861494 * (A - D), D = l + k, k = .566944034816 * (l - k), l = u + S, u = .64682178336 * (u - S), S = h + C, h = .788154623451 * (h - C), C = p + x, x = 1.06067768599 * (p - x), p = m + j, j = 1.72244709824 * (m - j), m = b + B, b = 5.10114861869 * (b - B), B = E + m, m = .509795579104 * (E - m), E = Q + p, Q = .601344886935 * (Q - p), p = D + C, C = .899976223136 * (D - C), D = l + S, S = 2.56291544774 * (l - S), l = B + D, B = .541196100146 * (B - D), D = E + p, p = 1.30656296488 * (E - p), E = l + D, D = .707106781187 * (l - D), l = B + p, p = .707106781187 * (B - p), l += p, B = m + S, S = .541196100146 * (m - S), m = Q + C, C = 1.30656296488 * (Q - C), Q = B + m, m = .707106781187 * (B - m), B = S + C, C = .707106781187 * (S - C), B += C, Q += B, B += m, S = m + C, m = n + b, n = .509795579104 * (n - b), b = A + j, A = .601344886935 * (A - j), j = k + x, x = .899976223136 * (k - x), k = u + h, h = 2.56291544774 * (u - h), u = m + k, m = .541196100146 * (m - k), k = b + j, j = 1.30656296488 * (b - j), b = u + k, k = .707106781187 * (u - k), u = m + j, j = .707106781187 * (m - j), u += j, m = n + h, n = .541196100146 * (n - h), h = A + x, x = 1.30656296488 * (A - x), A = m + h, h = .707106781187 * (m - h), m = n + x, n = .707106781187 * (n - x), m += n, A += m, m += h, h += n, b += A, A += u, u += m, m += k, k += h, h += j, j += n, E += b, b += Q, Q += A, A += l, l += u, u += B;
          B += m, m += D, D += k, k += S, S += h, h += p, p += j, j += C, C += n, i[o + 48] = -M, i[o + 49] = i[o + 47] = -E, i[o + 50] = i[o + 46] = -y, i[o + 51] = i[o + 45] = -b, i[o + 52] = i[o + 44] = -s, i[o + 53] = i[o + 43] = -Q, i[o + 54] = i[o + 42] = -F, i[o + 55] = i[o + 41] = -A, i[o + 56] = i[o + 40] = -r, i[o + 57] = i[o + 39] = -l, i[o + 58] = i[o + 38] = -I, i[o + 59] = i[o + 37] = -u, i[o + 60] = i[o + 36] = -f, i[o + 61] = i[o + 35] = -B, i[o + 62] = i[o + 34] = -d, i[o + 63] = i[o + 33] = -m, i[o + 32] = -a, i[o + 0] = a, i[o + 31] = -D, i[o + 1] = D, i[o + 30] = -R, i[o + 2] = R, i[o + 29] = -k, i[o + 3] = k, i[o + 28] = -c, i[o + 4] = c, i[o + 27] = -S, i[o + 5] = S, i[o + 26] = -T, i[o + 6] = T, i[o + 25] = -h, i[o + 7] = h, i[o + 24] = -g, i[o + 8] = g, i[o + 23] = -p, i[o + 9] = p, i[o + 22] = -w, i[o + 10] = w, i[o + 21] = -j, i[o + 11] = j, i[o + 20] = -v, i[o + 12] = v, i[o + 19] = -C, i[o + 13] = C, i[o + 18] = -U, i[o + 14] = U, i[o + 17] = -n, i[o + 15] = n, i[o + 16] = 0
        ...
        var t = function t(e) {
          ...
          var o = this.gl,
            s = null;
          this.vertexBuffer = o.createBuffer();
          var n = new Float32Array([0, 0, 0, 1, 1, 0, 1, 1]);
          o.bindBuffer(o.ARRAY_BUFFER, this.vertexBuffer), o.bufferData(o.ARRAY_BUFFER, n, o.STATIC_DRAW), this.program = this.createProgram(t.SHADER.VERTEX_IDENTITY, t.SHADER.FRAGMENT_YCRCB_TO_RGBA), s = o.getAttribLocation(this.program, "vertex"), o.enableVertexAttribArray(s), o.vertexAttribPointer(s, 2, o.FLOAT, !1, 0, 0), this.textureY = this.createTexture(0, "textureY"), this.textureCb = this.createTexture(1, "textureCb"), this.textureCr = this.createTexture(2, "textureCr"), this.loadingProgram = this.createProgram(t.SHADER.VERTEX_IDENTITY, t.SHADER.FRAGMENT_LOADING), s = o.getAttribLocation(this.loadingProgram, "vertex"), o.enableVertexAttribArray(s), o.vertexAttribPointer(s, 2, o.FLOAT, !1, 0, 0), this.shouldCreateUnclampedViews = !this.allowsClampedTextureData()
        };
        return t.prototype.destroy = function () {
          ...
          var i = this.gl,
            o = i.createTexture();
          return i.bindTexture(i.TEXTURE_2D, o), i.texParameteri(i.TEXTURE_2D, i.TEXTURE_MAG_FILTER, i.LINEAR), i.texParameteri(i.TEXTURE_2D, i.TEXTURE_MIN_FILTER, i.LINEAR), i.texParameteri(i.TEXTURE_2D, i.TEXTURE_WRAP_S, i.CLAMP_TO_EDGE), i.texParameteri(i.TEXTURE_2D, i.TEXTURE_WRAP_T, i.CLAMP_TO_EDGE), i.uniform1i(i.getUniformLocation(this.program, e), t), o
        }, t.prototype.createProgram = function (t, e) {
          var i = this.gl,
            o = i.createProgram();
          return i.attachShader(o, this.compileShader(i.VERTEX_SHADER, t)), i.attachShader(o, this.compileShader(i.FRAGMENT_SHADER, e)), i.linkProgram(o), i.useProgram(o), o
        }, t.prototype.compileShader = function (t, e) {
          var i = this.gl,
            o = i.createShader(t);
          if (i.shaderSource(o, e), i.compileShader(o), !i.getShaderParameter(o, i.COMPILE_STATUS)) throw new Error(i.getShaderInfoLog(o));
          return o
          ...
          if (this.enabled) {
            var o = this.gl,
              ...
              r = s >> 1,
              A = n >> 1;
            this.shouldCreateUnclampedViews && (t = new Uint8Array(t.buffer), e = new Uint8Array(e.buffer), i = new Uint8Array(i.buffer)), o.useProgram(this.program), this.updateTexture(o.TEXTURE0, this.textureY, s, n, t), this.updateTexture(o.TEXTURE1, this.textureCb, r, A, e), this.updateTexture(o.TEXTURE2, this.textureCr, r, A, i), o.drawArrays(o.TRIANGLE_STRIP, 0, 4)
          }
        }, t.prototype.updateTexture = function (t, e, i, o, s) {
          var n = this.gl;
          n.activeTexture(t), n.bindTexture(n.TEXTURE_2D, e), n.texImage2D(n.TEXTURE_2D, 0, n.LUMINANCE, i, o, 0, n.LUMINANCE, n.UNSIGNED_BYTE, s)
        ...
        return t.prototype.destroy = function () {}, t.prototype.resize = function (t, e) {
          this.width = 0 | t, this.height = 0 | e, this.canvas.width = this.width, this.canvas.height = this.height, this.imageData = this.context.getImageData(0, 0, this.width, this.height), o.Fill(this.imageData.data, 255)
        }, t.prototype.renderProgress = function (t) {
          var e = this.canvas.width,
            i = this.canvas.height,
            o = this.context;
          o.fillStyle = "#222", o.fillRect(0, 0, e, i), o.fillStyle = "#fff", o.fillRect(0, i - i * t, e, i * t)
        }, t.prototype.render = function (t, e, i) {
          this.YCbCrToRGBA(t, e, i, this.imageData.data), this.context.putImageData(this.imageData, 0, 0)
        }, t.prototype.YCbCrToRGBA = function (t, e, i, o) {
          if (this.enabled)
            for (var s, n, r, A, a, l = this.width + 15 >> 4 << 4, c = l >> 1, u = 0, d = l, h = l + (l - this.width), f = 0, p = c - (this.width >> 1), v = 0, m = 4 * this.width, g = 4 * this.width, b = this.width >> 1, y = this.height >> 1, B = 0; B < y; B++) {
              for (var w = 0; w < b; w++) {
                s = e[f], n = i[f], f++, r = s + (103 * s >> 8) - 179, A = (88 * n >> 8) - 44 + (183 * s >> 8) - 91, a = n + (198 * n >> 8) - 227;
                var j = t[u++],
                  E = t[u++];
                o[v] = j + r, o[v + 1] = j - A, o[v + 2] = j + a, o[v + 4] = E + r, o[v + 5] = E - A, o[v + 6] = E + a, v += 8;
                var x = t[d++],
                  T = t[d++];
                o[m] = x + r, o[m + 1] = x - A, o[m + 2] = x + a, o[m + 4] = T + r, o[m + 5] = T - A, o[m + 6] = T + a, m += 8
              }
              u += h, d += h, v += g, m += g, f += p
            }
        }, t
      }(), o.AudioOutput.WebAudio = function () {
        "use strict";
        var t = function t(e) {
        ...
        return t.prototype.destroy = function () {
          ...
          if (this.enabled) {
            ...
            var n = this.context.createBuffer(2, e.length, t);
            n.getChannelData(0).set(e), n.getChannelData(1).set(i);
            var r = this.context.createBufferSource();
            r.buffer = n, r.connect(this.destination);
            var A = this.context.currentTime,
              a = n.duration;
            this.startTime < A && (this.startTime = A, this.wallclockStartTime = o.Now()), r.start(this.startTime), this.startTime += a, this.wallclockStartTime += a
          }
        }, t.prototype.stop = function () {
          this.gain.gain.value = 0
        }, t.prototype.getEnqueuedTime = function () {
          return Math.max(this.wallclockStartTime - o.Now(), 0)
        }, t.prototype.resetEnqueuedTime = function () {
          this.startTime = this.context.currentTime, this.wallclockStartTime = o.Now()
    ...
    xLtR: function (t, e, i) {
      ...
      var s = i("cGG2"),
        ...
        l = i("qRfI");
      t.exports = function (t) {
        return o(t), t.baseURL && !a(t.url) && (t.url = l(t.baseURL, t.url)), t.headers = t.headers || {}, t.data = n(t.data, t.headers, t.transformRequest), t.headers = s.merge(t.headers.common || {}, t.headers[t.method] || {}, t.headers || {}), s.forEach(["delete", "get", "head", "post", "put", "patch", "common"], function (e) {
          delete t.headers[e]
        }), (t.adapter || A.adapter)(t).then(function (e) {
          return o(t), e.data = n(e.data, e.headers, t.transformResponse), e
        }, function (e) {
          return r(e) || (o(t), e && e.response && (e.response.data = n(e.response.data, e.response.headers, t.transformResponse))), Promise.reject(e)
        })
      }
    },
    ytBe: function (t, e, i) {
