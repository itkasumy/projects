...
(function () {
    ...
    google.maps.Load = function (apiLoad) {
        ...
        apiLoad([0.009999999776482582, [null, [["https://mts0.google.com/maps/vt?lyrs=s@718\u0026hl=zh-Hans-CN\u0026gl=CN\u0026", "https://mts1.google.com/maps/vt?lyrs=s@718\u0026hl=zh-Hans-CN\u0026gl=  CN\u0026"], null, null, null, 1, "718", ["https://khms0.google.com/kh?v=718\u0026hl=zh-Hans-CN\u0026gl=CN\u0026", "https://khms1.google.com/kh?v=718\u0026hl=zh-Hans-CN\u0026gl=CN\u0026"]], null, null, null, null, [["https://www.google.cn/cbk?", "https://www.google.cn/cbk?"]], [["https://khms0.googleapis.com/kh?v=103\u0026hl=zh-Hans-CN\u0026gl=CN\u0026", "https://khms1.googleapis.com/kh?v=103\u0026hl=zh-Hans-CN\u0026gl=CN\u0026"], null, null, null, null, "103", ["https://khms0.google.com/kh?v=103\u0026hl=zh-Hans-CN\u0026gl=CN\u0026", "https://khms1.google.com/kh?v=103\u0026hl=zh-Hans-CN\u0026gl=CN\u0026"]], [["https://mts0.googleapis.com/mapslt?hl=zh-Hans-CN\u0026gl=CN\u0026", "https://mts1.googleapis.com/mapslt?hl=zh-Hans-CN\u0026gl=CN\u0026"]], null, null, null, [["https://mts0.googleapis.com/mapslt?hl=zh-Hans-CN\u0026gl=CN\u0026", "https://mts1.googleapis.com/mapslt?hl=zh-Hans-CN\u0026gl=CN\u0026"]]], ["zh-Hans-CN", "CN", null, 0, null, null, "/static/google/mapfiles/", "", "", "", null, "https://maps.google.com", "https://gg.google.com", "/static/google/mapfiles/", "", 1, "https://www.google.com"], ["/static/google/js/", "3.28.6"], [3139439266], 1, null, null, null, null, null, "", null, null, 1, "https://khms.google.cn/mz?v=718\u0026", "AIzaSyDY0kkJiTPVd2U7aTOAwhc9ySH6oHxOIYM", "https://earthbuilder.googleapis.com", "https://earthbuilder.googleapis.com", null, "https://mts.googleapis.com/maps/vt/icon", [["https://maps.google.cn/maps/vt"], ["https://maps.google.cn/maps/vt"], null, null, null, null, null, null, null, null, null, null, ["https://www.google.com/maps/vt"], "/maps/vt", 375000000, 375], 2, 500, [null, null, null, null, "https://www.google.com/maps/preview/log204", "", "https://static.panoramio.com.storage.googleapis.com/photos/", ["https://www.google.cn/cbk"], "https://www.google.cn/maps/api/js/GeoPhotoService.GetMetadata", "https://www.google.cn/maps/api/js/GeoPhotoService.SingleImageSearch", ["https://lh3.ggpht.com/", "https://lh4.ggpht.com/", "https://lh5.ggpht.com/", "https://lh6.ggpht.com/"]], ["https://www.google.com/maps/api/js/master?pb=!1m2!1u28!2s6!2szh-Hans-CN!3sCN!4s28/6/intl/zh_cn", "https://www.google.com/maps/api/js/widget?pb=!1m2!1u28!2s6!2szh-Hans-CN"], null, 0, null, "/maps/api/js/ApplicationService.GetEntityDetails", 0, null, null, [null, null, null, null, null, null, null, null, null, [0, 0]], null, [], ["28.6"]], loadScriptTime);
    };
...
(function (_) {
    ...
    Pg = function () {
        ...
        if (5 == this.b || 6 == this.b || 2 == this.b)if (b = /OS (?:X )?(\d+)[_.]?(\d+)/.exec(this.l)) this.m = new Ig((0, window.parseInt)(b[1], 10), (0, window.parseInt)(b[2] || "0", 10));
    ...
    _.k.set = function (a, b) {
        ...
        a += "";
        var d = pb(c, a);
        if (d)if (a = d.Ya, d = d.Ac, c = "set" + _.Jb(a), d[c]) d[c](b); else d.set(a, b); else this[a] = b, c[a] = null, Gb(this, a)
    };
    ...
    var Fi = _.Ub.google.maps, Gi = Sc.b(), Hi = (0, _.p)(Gi.Za, Gi);
    Fi.__gjsload__ = Hi;
    _.ab(Fi.modules, Hi);
    delete Fi.modules;
    ...
    _.k.changed = function () {
        var a = this.Kg(), b = this.$f(), c = qg(this);
        if (a && !a.b(this.G) || this.F != b || this.O != c) rg(this.f), this.K(), this.F = b, this.O = c;
        this.G = a
    };
    _.k.Z = function () {
        var a = "", b = this.Kg(), c = this.$f(), d = qg(this), e = this.get("size");
        if (e) {
    ...
    var mj = {
        ...
        NavigationControlStyle: {
            DEFAULT: 0, SMALL: 1,
            ANDROID: 2, ZOOM_PAN: 3, oo: 4, Bj: 5
        },
        OverlayView: _.Dg,
        Point: _.G,
        Polygon: _.Le,
